...
This is a **dog hotel management system** that allows you to manage a lot of data in one place: guests and their booked rooms, on-site services with their reservations for specific time slots, and even the menus for each meal of the day.

I'll write more about the technology below. First some screenshots:


![Everything about a guest is gathered in one place, on the Guests tab.](Pudelwohl_screenshot1.png)
Everything about a guest is gathered in one place, on the Guests tab.

---
![Rooms are color-coded according to their occupancy on the selected date. Select a room and you'll see all of its bookings.](Pudelwohl_screenshot2.png)
Rooms are color-coded according to their occupancy on the selected date. Select a room and you'll see all of its bookings.

---
![The tab with on-site services, their time slots, bookings, and all the relevant information.](Pudelwohl_screenshot3.png)
The tab with on-site services, their time slots, bookings, and all the relevant information.

--- 
![A simple dialog for booking a service.](Pudelwohl_screenshot4.png)
A simple dialog for booking a service.

---
![The daily menu.](Pudelwohl_screenshot5.png)
The daily menu.

---
![When the panel with the meal options is expanded, the menu selection controls are resized to remain usable.](Pudelwohl_screenshot6.png)
