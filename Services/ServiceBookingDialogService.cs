...
namespace Pudelwohl_Hotel_and_Resort_Management_Suite_Ultimate_Wuff_Wuff.Services
{
    ...
    public interface IServiceBookingDialogService
    {
        ...
        /// <param name="isServiceSelectable">True if the service should be selectable, false otherwise (serviceId is fixed then)</param>
        /// <param name="isTimeSlotSelectable">True if the time slot should be selectable, false otherwise (startTime is fixed then)</param>
